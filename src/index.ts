...
InvisableBlock.rotateTo(RotationAngle.COUNTER_CLOCKWISE).stuffWith(Stuffable.BOOT);
console.log(InvisableBlock);
let KaizoBlock = j2t.block.KaizoBlock();
KaizoBlock.rotateTo(RotationAngle.COUNTER_CLOCKWISE).stuffWith(Stuffable.BOOT);
console.log(KaizoBlock);
let MetalBlock = j2t.block.MetalBlock();
MetalBlock;
console.log(MetalBlock);
let QuestionBlock = j2t.block.QuestionBlock();
QuestionBlock.rotateTo(RotationAngle.COUNTER_CLOCKWISE).stuffWith(Stuffable.BOOT);
...
TronicIf.pushToBackground().rotateTo(RotationAngle.CLOCKWISE).trueFlowTo(gravBlock).falseFlowTo(gravBlock).a(gravBlock).b(gravBlock).groupTo(gravBlock).ifOperator(IfOperator.EQUAL);
